...
SUITES = {
    ...
    "integration-tools": [["-m", "unittest", "mb.test.test_product_integration", "mb.test.test_grit_resource_ids", "mb.test.test_browser_tests", "mb.test.test_product_profiles", "mb.test.test_product_process_guard", "-v"]],
